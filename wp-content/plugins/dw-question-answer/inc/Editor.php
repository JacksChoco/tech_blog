...
class DWQA_Editor {
	...
	public function display( $args ) {
		...
		$toolbar1 = apply_filters( 'dwqa_tinymce_toolbar1', 'bold,italic,underline,|,' . 'bullist,numlist,blockquote,|,' . 'link,unlink,fontsizeselect,|,' . 'image,|,'. 'spellchecker,fullscreen,|,' );
